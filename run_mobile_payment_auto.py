"""
Script automatique pour lancer un test de paiement Mobile Money
Montant: 1000 XAF
Numéro: +237657807309
Continue automatiquement jusqu'à ce que le paiement soit accepté
"""
...
async def main():
    ...
    success, transaction_id = await run_mobile_payment_test()
