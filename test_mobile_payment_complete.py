"""
Script complet de test pour paiement Mobile Money
Montant: 1000 XAF
Numéro: +237657807309
...
async def initiate_payment():
    """Initialise un paiement Mobile Money avec CinetPay"""
    print("\n" + "="*80)
    print("TEST COMPLET: PAIEMENT MOBILE MONEY")
    print("="*80)
    ...
    description = clean_payment_description("Test paiement Mobile Money 200 XAF")
    ...
    payload = {
        ...
        "metadata": "Test-Mobile-Money-200",
        "invoice_data": {
            "Service": "LAFAOM-MAO",
    ...
    try:
        async with httpx.AsyncClient(timeout=30.0) as client:
            ...
            if response_code == "201":
                ...
                print(f"   2. Ou validez directement sur votre téléphone: {MOBILE_PHONE}")
...
async def main():
    """Fonction principale"""
    print("\n" + "="*80)
    print("TEST COMPLET: PAIEMENT MOBILE MONEY - 200 XAF")
    print("="*80)
    print("\nCe script va:")
    print("1. ✅ Initialiser un paiement de 200 XAF")
